...
// Konstruktor klasy inicjalizujący instancję i wzywający metody startowe.
...
// Destruktor czyszczący obiekty GDI, w tym ikony systemowe i akceleratory.
...
// Rejestruje bazowe typy okien w WinAPI przed ich wykreowaniem.
...
// Alokuje nowe obiekty na ekranie i dopasowuje obszar roboczy Windowsa do wymagań.
...
// Kreuje tęczę pikseli wewnątrz GDI po to by wyciąć z niej małą systemową ikonę okienka HICON.
...
// Przechwytuje i tłumaczy globalną pętlę zdarzeń wraz ze wsparciem wbudowanych klawiszy akceleratorów.
...
// Globalna procedura w strukturze c-style dla obsługi nadchodzących od systemu zdarzeń okna docelowego.
...
// Rozdzielacz wewnętrzny poleceń okna kanwy używany dla dedykowanej już instancji (obiektu) w C++.
...
// Procedura globalna obsługująca zadeklarowany dolny pasek śladów paska GDI.
...
// Wewnętrzny sterownik zdarzeń okna dla dedykowanego obszaru dolnego paska gradientu.
...
// Globalny przechwytywacz hooka (C-style callback) nasłuchujący kliknięć myszy w poszukiwaniu pikseli ekranu.
...
// Główna pętla dialogowa symulująca zachowanie modalne Win32. Renderuje panel i pobiera wykończony kolor.
...
// Globalny delegator procedury okienka dla panelu pickera, pozwalający instancji klasy obsługiwać wiadomości Win32.
...
// Faktyczna wbudowana procedura dla elementu okna dialogowego Color Pickera sterująca jego rysowaniem oraz logiką.
